...
//    {
//        return ManagementFactory.CreateAllocableManagement().GetMonoAllocableEquips();
//    }
//
//    public List<DBLocation> GetAllLocations()
//    {
//        return ManagementFactory.CreateAllocableManagement().GetAllLocations();
//    }
//
...
//    }
//
//    public Dictionary<string, int> GetMultiAllocablesByMonoAllocable(int idMonoAllocable, DateTime date, TimeSpan beginTime, TimeSpan endTime)
//    {
